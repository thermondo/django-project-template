...
django-admin startproject --template ./django_project_template --extension=py,md,lock,cfg,yml,yaml --name .env,.editorconfig,.gitignore,Pipfile,Procfile,.bandit "$PROJECT_NAME" "$PROJECT_PATH"
